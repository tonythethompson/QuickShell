...
; Build script sets IncludeRunPlugin, InstallerBaseName, and DisplayName per variant.
...
#define InstallerBaseName "QuickShell"

#define IncludeRunPlugin "true"
...
OutputBaseFilename={#InstallerBaseName}-Setup-{#AppVersion}
