...
#define ExtensionSource "C:\\Users\\tonyt\\.cursor\\worktrees\\QuickShell\\gtdi\\QuickShell.Raycast\\bin\\Release\\package"
...
[Messages]
FinishedLabel=Quick Shell for Raycast was copied to %n%n{#ExtensionDest}%n%nOpen Raycast, then use Developer â†’ Import Extension if the commands do not appear automatically. You need Raycast for Windows installed.
