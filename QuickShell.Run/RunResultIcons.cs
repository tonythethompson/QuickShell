...
internal static class RunResultIcons
{
    ...
    public static void ApplyToResult(Result result, string icon, TerminalShortcut? shortcut = null)
    {
        icon = NormalizeIcon(icon, shortcut);
    ...
    private static string NormalizeIcon(string icon, TerminalShortcut? shortcut)
    {
        ...
        {
            var fallback = TerminalLaunchGlyphs.GetForShortcut(shortcut);
